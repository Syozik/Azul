...
This is an online version of game [Azul](https://en.wikipedia.org/wiki/Azul_(board_game)).
Its 'Summer Pavilion' extension to be presize. Me and my girlfriend found it such an interesting game,
...
This starts the Next.js dev server with the Socket.io backend on `http://localhost:3000`.
